...
class ReservationForm extends Form
{
    ...
    {
        $data['date_depart'] = explode('T', $data['date_depart']);
        $data['date_arriver'] = explode('T', $data['date_arriver']);
        $data['date_arriver'] = $data['date_arriver'][0].' '.$data['date_arriver'][1];
        $data['date_depart'] = $data['date_depart'][0].' '.$data['date_depart'][1];
