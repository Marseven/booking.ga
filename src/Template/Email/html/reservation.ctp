...
<div class="container">
    ...
    <div class="statusorder">
        <div class="boxstatusorder"><span class="Stile1">Référence de la réservation : <?=$contenu['reference']?></span></div>

        <div class="boxstatusorder"><span class="Stile1">Statuts de la réservation: <?=$contenu['status']?></span></div>
        <div class="boxstatusorder"><strong>Date de la commande: <?=$contenu['date']?></strong>
        </div>
    </div>
    <div class="persdetail">
        <h3 class="Stile1">Détails personnels:</h3>
        Prénom : <?=$contenu['prenom']?><br />
        Nom : <?=$contenu['nom']?><br />
        e-mail : <?=$contenu['email']?><br />
        Téléphone : <?=$contenu['telephone']?><br />
        Date de naissance : <?=$contenu['date_naissance']?><br />


    </div>
    <div class="hiremainbox">
        <div class="hirecar clearfix">
        <p><span class="Stile1">Véhicule loué : <?=$contenu['brand']." ".$contenu['title']?>
</span></p>
        <div class="hiredate">
            <p><span class="Stile12">Date de départ:</span>
                <span class="Stile9"> <?=$contenu['date_depart']?>
</span></p>
        ...
        <div class="hiredate">
            <p><span class="Stile12">Date de retour: </span>
                <span class="Stile9"> <?=$contenu['date_arriver']?>
</span></p>
    ...
    <div class="hireorderdetail">
        <p><span class="Stile1">Détails de commande:</span></p>
        <div class="hireordata hiretotal"><span class="Stile10">Total</span><div align="right"><strong> <?=$contenu['montant']?> FCFA</strong></div></div>
</div>
<br/>
<p><br/>
